...
def("web", function(exports, module) {
    ...
    var loginUI = function() {
        ...
        if(solsortLogin) {
            ...
            if(!userId) {
                solsortLogin.innerHTML = '<ul class="nav"><li class="dropdown">' +
                    '<a href="#" class="dropdown-toggle" data-toggle="dropdown">Login<b class="caret"></b></a>' +
                    '<ul class="dropdown-menu">' +
                    '<li><a href="javascript:use(\'web\').loginGitHub()"><span class="icon-github"></span> github</a></li>' +
                    '<li><a href="#" onclick="use(\'web\').loginFacebook()"><span class="icon-facebook-sign"></span> facebook</a></li>' +
                    '<li><a href="#" onclick="use(\'web\').loginGoogle()"><span class="icon-google-plus-sign"></span> google</a></li>' +
                    '</ul></li></ul>';
            } else {
                solsortLogin.innerHTML = '<ul class="nav"><li><a onclick="use(\'web\').logout();">' +
                    userName + '<span class="icon-' + {
                        github: 'github', 
                        facebook: 'facebook-sign', 
                        google: 'google-plus-sign'}[userId.split(':')[0]] +
                    ' icon-large"></span>' + 'logout' +
        ...
        if(loggingIn) {
            ...
            if(loggingIn === 'github') {
                exports.jsonp('http://solsort.com/githubLogin', exports.getVars(), function(access_token) {
                    ...
                    exports.jsonp('https://api.github.com/user', {access_token: access_token},
                        function(data) {
                            if(data.data.login) {
