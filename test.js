...
var rst = ls.parse(ls.tokenise(require('fs').readFileSync('syntax.js', 'utf8')))
...
console.log(ls.prettyprint({kind:'block', children: rst.map(rst2ast).filter(function(elem) { return elem.val !== ';'; })}));
