...
###Transformation library and matcher instantations
...
#### noSeps utility function for filtering away separators from lists 

      noSeps = function(list) {
        return list.filter(notSep);
      };

#### Definition of matchers: rstToAst, astToLs and astToJs

      rstToAst = new Matcher();
      astToLs = new Matcher();
      astToJs = new Matcher();

#### structural transformations via matchReplace, and -To-Transform
##### matchReplace
...
#### shorthands for defining patterns/transforms on both JS and LS
...
#### ++ += -- -= *=  transformed to binop + assignment
...
### Common transformations for Js and Ls
#### control flow
...
#### functions, and function/method-application
...
#### activities
        ...
        if(app.args[1] === "activities") {
          ...
          */
          ...
          app.done({activities : activities});
