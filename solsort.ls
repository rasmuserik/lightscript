...
//{{{2 Tango
//
//{{{3 AFLYST Eftermiddagsmilonga d. 4 januar 2014 AFLYST
//
// Eftermiddagsmilongaen på lørdag er aflyst :(
//
// Næste mikromilonga er lørdag d. ?. januar, kl ??, hos Rasmus Erik.
//
...
//   - Delivered within weeks or months
